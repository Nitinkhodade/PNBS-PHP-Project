    ...
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Sindoor Daan</li>
            </ol>
        </div>
        ...
        <div class="col-lg-12">
            ...
            <div class="card card-outline-info">
                <div class="card-header">
                    <h4 class="m-b-0 text-white"> Sindoor Daan Booking <!--<a href="#" class="btn btn-info pull-right"><i class="fa fa-list"></i> Edit </a>--></h4>
                ...
                <div class="card-body">
                    <form method="post" action="<?php echo base_url('admin/user/add_anjalibookingdashmi') ?>" class="form-horizontal" enctype="multipart/form-data" novalidate>
                        <div class="form-body">
                            <br>
						...
						<!--  <div class="row">
							...
							<div class="row">
                                 <div class="col-md-9">
									...
									<label class="control-label text-right col-md-3">&nbsp;</label>
                                    <div class="col-md-9 controls">
									<h5 style="font-size: .8rem; color: #757575;">*Only three married ladies from each registered member family are allowed for sindoor daan.</h5>
									<h5 style="font-size: .8rem; color: #757575;">*If any male and children are accompanying will have to wait at the waiting area.</h5>
									<h5 style="font-size: .8rem; color: #757575;">*Members are requested to come within the booked time slots.</h5>
									<h5 style="font-size: .8rem; color: #757575;">*All the rights are reserved with the committee and request you all to co-operate during this pandemic times.</h5>
								  </div>
   ...
   <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card card-outline-warning">
                <div class="card-header">
                    <h4 class="m-b-0 text-white"> List of Booking <!--<a href="#" class="btn btn-info pull-right"><i class="fa fa-list"></i> Edit </a>--></h4>
					  ...
					  <?php foreach($userlist as $userc) {  ?>
                                ...
                                <div class="col-md-3">
									<div class="card card-outline-danger">
										...
										<div class="card-body">
											<h3 class="card-title"><?php echo slotbooking1($userc['slotno']);  ?></h3>
											<p class="card-text">Number of person: <?php echo $userc['totalperson'];  ?></p>
											<h3 class="card-title">Coupon Code </h3><a href="#" class="btn-lg btn-inverse"><?php echo $userc['passcode'];  ?></a>
											
											
											<br>
											<br>
											<a href="<?php echo base_url(); ?>admin/user/deleteabook1/<?php echo $userc['id'] ?>"  onclick="return confirm('Are you sure you want to cancel this slot?');" class="btn-lg  btn-danger">Cancel</a>
