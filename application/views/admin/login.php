...
<body>
    ...
    <section id="wrapper">
        ...
        <div class="login-register" style="background-image:url(<?php echo base_url() ?>assets/images/background/backgound_login.png);position: fixed;">
            ...
            <div class="card-body">
                ...
                <form class="form-horizontal form-material" id="login-form" action="<?php echo base_url('auth/log'); ?>" method="post">
                   ...
                   <div class="form-group">
					...
					<p style="margin-top: 10px;"><a style="color:#000;" target="_blank" href="https://thepnbs.com/privacy-policy.html" class="forgot pull-right"> <i class="fa fa-empire"></i> Privacy Policy</a> 
		   ...
		   <!--<h1 class="box-title m-b-40 text-center" style="line-height: 750px;">Comming Soon...</h1>-->
