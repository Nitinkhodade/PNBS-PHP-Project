...
<body>
    ...
    <section id="wrapper">
        ...
        <div class="login-register" style="background-image:url(<?php echo base_url() ?>assets/images/background/backgound_login.png);position: fixed;">
           <!-- <h2 class="box-title m-b-40 text-center"><img src="<?php echo base_url() ?>assets/images/top.png" alt="homepage" class="dark-logo" /></h2>         -->
		   <br><br><br><br><br><br><br><br><br>
            ...
            <div class="card-body">
                ...
                <form class="form-horizontal form-material" id="login-form" action="<?php echo base_url('auth/log'); ?>" method="post">
                    <h2 class="box-title m-b-40 text-center">Sign In PNBS</h2>
                    <div class="form-group ">
                        <div class="col-xs-12">
                            <input class="form-control" type="text" name="user_name" required="" placeholder="Mobile Number"> </div>
                    </div>
                    <div class="form-group">
                        <div class="col-xs-12">
                    ...
                    <div class="form-group text-left m-t-50">
                        <div class="col-xs-12">
					...
					<p style="margin-top: 10px;"><a style="color:#000;" href="https://thepnbs.com/privacy-policy.html" class="forgot pull-right"> <i class="fa fa-empire"></i> Privacy Policy</a> 
					<a style="color:#000; padding-right: 20px;" href="https://thepnbs.com/terms_and_conditions.html" class="forgot pull-right"> <i class="fa fa-empire"></i> Terms & Conditions</a>
                                 </p>
